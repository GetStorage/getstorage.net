    ...
    <body class="page page-index-static">
                ...
                <div class="container">
                    <div class="navbar-inner">
                        ...
                        <ul class="nav user-menu pull-right">
                            @if(!Sentry::check())
                            <li>{{HTML::linkAction('AccountController@getRegister', 'Sign Up', null, array('class' =>
                                'btn btn-primary signup'))}}
                            </li>
                            <li>{{HTML::linkAction('AccountController@getLogin', 'Login', null, array('class' => 'btn
                                btn-primary login'))}}
                            </li>
                            @else
                            @if(Sentry::getUser()->inGroup(Sentry::getGroupProvider()->findByName('Admins')))
                            <li>{{HTML::linkAction('AdminHomeController@getIndex', 'Admin', null, array('class' => 'btn
                                btn-danger'))}}
                            </li>
                        ...
                        <div class="nav-collapse collapse">
                            ...
                            <ul class="nav" id="main-menu">
                                <li class="home-link">
                                    <a href="{{URL::to('/')}}"><i class="icon-home hidden-phone"></i><span class="visible-phone">Home</span></a>
                                </li>
                                <li>{{HTML::linkAction('DocsController@getApps', 'Apps', null, array('class' =>
                                    'menu-item'))}}
                                </li>
                                <li>{{HTML::linkAction('DocsController@getApi', 'Api', 'v2', array('class' =>
                                    'menu-item'))}}
                                </li>
                            </ul>
                        </div>
        ...
        <div id="content-below" class="wrapper">
            <div class="container">
                <div class="row-fluid">
                    <div class="upsell">
                        <small class="muted">99.9% Uptime <span class="spacer">//</span> Free upgrade assistence
                            <span class="spacer">//</span> 24/7 Support <span class="spacer">//</span> Plans from
                            $19.99/month <span class="spacer">//</span></small>
                        <a href="pricing.htm" class="btn btn-primary">Start your Free Trial Today!
